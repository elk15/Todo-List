...
class Project {
    ...
    addTask(title, description, dueDate, priority) {
        const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, 'yyyy-MM-dd', new Date());
