...
class Project {
    ...
    addTask(title, description, dueDate, priority, isCompleted = false) {
        ...
        this.tasks.push(new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](title, description, parsedDate, priority, isCompleted));
    }
    ...
    deleteTodaysTasks() {
        this.tasks = this.tasks.filter((task) => !(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate));
    }

    deleteThisWeeksTasks() {
        this.tasks = this.tasks.filter((task) => !(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate));
    }
    ...
    getTodaysTasks() {
        ...
        for (let i = 0; i < this.tasks.length; i += 1) {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.tasks[i].dueDate)) {
    ...
    getThisWeeksTasks() {
        let thisWeeksTasks = [];
        for (let i = 0; i < this.tasks.length; i += 1) {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(this.tasks[i].dueDate)) {
    ...
    sortByDueDate() {
        this.tasks.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(a.dueDate, b.dueDate));
    }
}
...
class ProjectPage {
    ...
    static projectSection = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.project');

    static projectTitle = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.project-title');

    static taskList = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.tasks');

    static sortModal = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sort-modal');

    static deleteModal = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.delete-modal');
    ...
    updateTaskAmount() {
        const taskAmountSpan = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement(`#amount-${this.projectIndex}`);
    ...
    createAddTaskBtn() {
        const addBtnDiv = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.add-task-btn');
    ...
    createAddTaskModal() {
        const addTaskDiv = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.add-task');
    ...
    handleCheck(check) {
        ...
        check.addEventListener('click', () => {
            ...
            _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveToStorage();
    ...
    handleChecks() {
        const checks = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.check');
    ...
    handleSortMenu() {
        const dueDateBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sort-dueDate');
        const priorityBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sort-priority');
    ...
    handleDeleteCompleted() {
        const deleteCompletedBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.delete-completed');
    ...
    handleDeleteAll() {
        const deleteAllBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.delete-all');
    ...
    handleAddTaskBtn() {
        const addTaskBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.add-task-btn').firstChild;
        addTaskBtn.addEventListener('click', () => {
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.add-task-btn');
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].showElement('.add-task');
        });
    }

    closeAddTaskModal() {
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].showElement('.add-task-btn');
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.add-task');
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#taskName').value = '';
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#description').value = '';
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#dueDate').value = this.getCurrentDate();
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.set-priority').dataset.priorityNumber = 4;
        _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.set-priority').innerHTML = '<i class="fa-regular fa-flag" style="color: #474545;"></i> Priority 4';
    }

    handleAddTaskModal() {
        const titleInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#taskName');
        const descriptionInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#description');
        const dueDateInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#dueDate');
        const priorityInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.set-priority');
        const cancelBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.cancel-submit-task');
        const submitBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.submit-task');
    ...
    handlePriorityBtn() {
        const priorityBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.set-priority');
        priorityBtn.addEventListener('click', () => {
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].toggleElement('.priority-modal');
        });
    }

    handlePriorityModal() {
        const prioritySpans = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.priority-option');
        const priorityInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.set-priority');
        prioritySpans.forEach((span) => {
            span.addEventListener('click', () => {
                ...
                _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.priority-modal');
            });
        });
    }
    ...
    toggleTasksBtns() {
        const tasks = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.task');
        tasks.forEach((task) => {
    ...
    editTasks() {
        const editBtns = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.edit-task-btn');
    ...
    deleteTasks() {
        const deleteBtns = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.delete-task-btn');
...
class Storage {
    static getData() {
        const data = {};
        data.Inbox = [];
        _TodoList__WEBPACK_IMPORTED_MODULE_0__["default"].inbox.getTasks().forEach((task) => {
            const tempArray = [];
        ...
        _TodoList__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects().forEach((project) => {
...
class Task {
    ...
    getReverseDueDate() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(this.dueDate, 'yyyy-MM-dd');
    }
...
const TodoList = (() => {
    ...
    const addProject = (title, color) => {
        userProjects.push(new _Project__WEBPACK_IMPORTED_MODULE_0__["default"](title, color));
    };
    ...
    const restoreData = (data) => {
        if (data != null) {
            data.Inbox.forEach((task) => {
                inbox.addTask(task[0], task[1], (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task[2], 'dd/MMM/yyyy', new Date()), task[3], task[4]);
            });
            ...
            projectTitles.forEach((title) => {
                if (title !== 'Inbox') {
                    ...
                    data[title].tasks.forEach((task) => {
                        getLastProject().addTask(task[0], task[1], (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task[2], 'dd/MMM/yyyy', new Date()), task[3], task[4]);
                    });
                }
            });
        }
...
const UI = (() => {
    const pages = [_ProjectPage__WEBPACK_IMPORTED_MODULE_2__["default"]["for"](_TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox, 0), _ProjectPage__WEBPACK_IMPORTED_MODULE_2__["default"]["for"](_TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox, 1),
        _ProjectPage__WEBPACK_IMPORTED_MODULE_2__["default"]["for"](_TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox, 2)];

    const removeSelectedFromAll = () => {
        const navItems = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.nav-item');
    ...
    const handleDeleteCompleted = () => {
        const deleteBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.delete-completed');

        deleteBtn.addEventListener('click', () => {
            updateTaskAmount();
            handleEditTaskBtns();
            handleDeleteTask();
            _Storage__WEBPACK_IMPORTED_MODULE_3__["default"].saveToStorage();
        });
    };

    const handleDeleteAll = () => {
        const deleteBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.delete-all');
    ...
    const handleSubmitTaskBtn = () => {
        const submitTaskBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.submit-task');
    ...
    const handleEditTaskBtns = () => {
        const editTaskBtns = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.edit-task-btn');
        editTaskBtns.forEach((editBtn) => {
            editBtn.addEventListener('click', () => {
                const updateBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.edit-task');
                ...
                const cancelBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.cancel-edit-task');
                cancelBtn.addEventListener('click', () => {
                    handleEditTaskBtns();
                    handleDeleteTask();
                });
    ...
    const handleSortBtns = () => {
        const sortDueDateBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sort-dueDate');
        sortDueDateBtn.addEventListener('click', () => {
            handleEditTaskBtns();
            handleDeleteTask();
            _Storage__WEBPACK_IMPORTED_MODULE_3__["default"].saveToStorage();
        });
        const sortPriorityBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sort-priority');
    ...
    const handleShowProjectModalBtn = () => {
        const addProjectBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.open-project-modal');
        addProjectBtn.addEventListener('click', () => {
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].showElement('.add-project-modal');
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].showElement('.overlay');
        });
    };

    const handleColorsModal = () => {
        const colorBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#project-color');
        colorBtn.addEventListener('click', () => {
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].toggleElement('.color-modal');
        });
        const colorSpans = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.color-option');
        colorSpans.forEach((span) => {
            span.addEventListener('click', () => {
                colorBtn.innerHTML = span.innerHTML;
                colorBtn.dataset.color = span.dataset.color;
                _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.color-modal');
            });
        });
    };
    ...
    const handleAddProjectModal = () => {
        handleColorsModal();
        const cancelBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.cancel-add-project');
        const addBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.add-project');
        const nameInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#project-title');
        const colorInput = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('#project-color');

        addBtn.addEventListener('click', () => {
            if (nameInput.value !== '') {
                _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].addProject(nameInput.value, colorInput.dataset.color);
                const project = _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].getLastProject();
                addUserProject(project);
                _Storage__WEBPACK_IMPORTED_MODULE_3__["default"].saveToStorage();
                _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.add-project-modal');
                _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement('.overlay');
                nameInput.value = '';
    ...
    const toggleMiniMenu = (name) => {
        const btn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement(`.${name}`);

        btn.addEventListener('click', () => {
            _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].toggleElement(`.${name}-modal`);
        });

        document.addEventListener('click', (e) => {
            if (e.target !== _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement(`.${name}`)) {
                _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].hideElement(`.${name}-modal`);
            }
        });
    };

    const toggleNavBar = () => {
        const toggleBtn = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.toggle-navbar');
        const sidebar = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.sidebar');
    ...
    const addUserProject = (project) => {
        pages.push(_ProjectPage__WEBPACK_IMPORTED_MODULE_2__["default"]["for"](project, pages.length));
        const projectsUl = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.projects');
        ...
        deleteBtn.addEventListener('click', () => {
            _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].deleteProject(newLi.id - 3);
    ...
    const appendUserProjects = () => {
        const projects = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.projects');
        projects.innerHTML = '';
        pages.splice(3);
        _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].getProjects().forEach((project) => addUserProject(project));
    };
