...
class Project {
    ...
    addTask(title, description, dueDate, priority) {
        ...
        if (typeof dueDate === 'string') {
            parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, 'yyyy-MM-dd', new Date());
        }
        this.tasks.push(new _Task__WEBPACK_IMPORTED_MODULE_0__["default"](title, description, parsedDate, priority));
    }
    ...
    changeTaskDueDate(index, newDueDate) {
        const parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(newDueDate, 'yyyy-MM-dd', new Date());
    ...
    sortByDueDate() {
        this.tasks.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(a.dueDate, b.dueDate));
    }
...
class Task {
    ...
    getDueDate() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(this.dueDate, 'dd/MMM/yyyy');
    }
...
const TodoList = (() => {
    ...
    const getTodaysTasks = () => {
        const tasks = inbox.getTasks().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate));
        const todayInbox = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]('Today');
        tasks.forEach((task) => {
    ...
    const getThisWeeksTasks = () => {
        const tasks = inbox.getTasks().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate));
        const thisWeekInbox = new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]('This Week');
        tasks.forEach((task) => {
    ...
    const addProject = (title) => {
        userProjects.push(new _Project__WEBPACK_IMPORTED_MODULE_0__["default"](title));
    };
...
const UI = (() => {
    const todayAmount = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.amount-today');
    const inboxAmount = _Utils__WEBPACK_IMPORTED_MODULE_0__["default"].getElement('.amount-inbox');
    inboxAmount.innerHTML = _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.getTasksAmount();
    todayAmount.innerHTML = _TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTasks().getTasksAmount();

    console.log(_TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.getTasks());
    const inboxPage = projectPage(_TodoList__WEBPACK_IMPORTED_MODULE_1__["default"].inbox).page;
